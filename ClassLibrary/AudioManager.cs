//Klass som är skapat microsoft vi använder det dock till att hantera uppspelningen av ljud
//Små ändringar som vad för ljudfiler som den skall hämta in
...
namespace ClassLibrary
{
    ...
    public class AudioManager : Microsoft.Xna.Framework.GameComponent
    {
        ...
        public override void Initialize()
        {
            ...
            SoundEffect.DistanceScale = 100;//Öka för ljud som når längre
            SoundEffect.DopplerScale = 0.1f;

            // Load all the sound effects.
            foreach (string soundName in soundNames)
            {
                soundEffects.Add(soundName, Game.Content.Load<SoundEffect>("Audio/"+soundName));
            }

            Listener.Position = new Vector3(0, 0, 0);
            Listener.Forward = new Vector3(0, 0, 0);
            Listener.Up = new Vector3(0, 0, 0);
        ...
        public void attachCameraToAudio(Camera cam)
        {
            camera = cam;
        }
    }
